 ...
 * Time: 上午8:40
 */
class MPagination extends MComponent {
     ...
     * @param MController $controller the controller that will create the actual URL
    ...
    public function createPageUrl($controller, $page) {
        ...
        if ($this->route) {
            ...
            $uri = preg_replace('/' . $this->pageVar . '=\d*/', '', $controller->getRequest()->uri);
            return curl($uri, $params);
        }
    }
