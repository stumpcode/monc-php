...
class CBooleanValidator extends CValidator {
    ...
    protected function validateAttribute($object, $attribute) {
        ...
        if (!$this->strict && $value != $this->trueValue && $value != $this->falseValue
            ...
            $message = $this->message !== null ? $this->message :
                Yii::t('yii', '{attribute} must be either {true} or {false}.');
    ...
    public function clientValidateAttribute($object, $attribute) {
        ...
        return "
if(" . ($this->allowEmpty ? "jQuery.trim(value)!='' && " : '') . "value!="
        . CJSON::encode($this->trueValue) . " && value!=" . CJSON::encode($this->falseValue) . ") {
